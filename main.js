...
var imgArr = ['images/cherry.png', 'images/club.png', 'images/orange.png', 'images/seven.png', 'images/bar.png']
...
function winCondition(){
  if(reel1 == reel2 && reel1 == reel3){
    ...
    document.getElementById('pot').innerHTML = 'Pot: ' + pot
    document.getElementById('bank').innerHTML = 'Bank: ' + bank
    document.getElementById('msg').innerHTML = 'Winner Winner Chicken Dinner'
  }else{
    pot = 0
    document.getElementById('pot').innerHTML = 'Pot: ' + pot
